...
<script>
  ...
  export default {
    ...
    methods: {
      sendopenkan(i) {
        var linlink = this.kanlistaaarrr[i].href
        window.open(linlink)
      },
      ...
      getallkanlist() {
        ...
        ajax.open('get', 'http://www.qmdsw.com/mall/pcIndex/indexLook?pageNo=' + this.pageNum + '&type=2');
        //步骤三:发送请求
        ajax.send();
      ...
      ksdfsafdasdf() {
        ...
        this.kanlistaaarrr = this.kanlist.records
        this.totlecnt = this.kanlist.total
